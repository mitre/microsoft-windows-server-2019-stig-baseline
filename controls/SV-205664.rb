...
standard users to only have Print permissions."
  ...
  tag nist: ['AC-3']
    ...
    describe "A manual review is required to verify that Non Administrative user accounts or groups only have print permissions on printer shares" do
      skip 'A manual review is required to verify that Non Administrative user accounts or groups only have print permissions on printer shares'
    end

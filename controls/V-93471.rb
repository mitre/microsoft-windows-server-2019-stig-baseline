...
control "V-93471" do
  title "Windows Server 2019 minimum password age must be configured to at
least one day."
...
Settings >> Security Settings >> Account Policies >> Password Policy.
    ...
    If the value for the \"Minimum password age\" is set to \"0\" days
(\"Password can be changed immediately\"), this is a finding.

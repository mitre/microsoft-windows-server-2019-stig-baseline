...
control 'SV-205697' do
  title "Windows Server 2019 must not have the Microsoft FTP service installed
unless required by the organization."
...
these services may not support required levels of authentication or encryption."
  ...
  desc  'check', "
    ...
    If the system has the role of an FTP server, this must be documented with
the ISSO.
  "
  desc  'fix', "

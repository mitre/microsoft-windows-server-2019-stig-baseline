...
Validate heap integrity, must be on."
...
heap integrity\", are enabled by default at the system level. \"Validate heap
integrity\" terminates a process when heap corruption is detected. If this is
turned off, Windows may be subject to various exploits."
  desc  "rationale", ""
  desc  "check", "
...
\"NOTSET\".
  ...
  "
  desc  "fix", "
    Ensure Exploit Protection system-level mitigation, \"Validate heap
...
the following to the XML file will explicitly turn Validate heap integrity on

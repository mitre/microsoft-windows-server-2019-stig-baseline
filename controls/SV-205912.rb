...
control 'SV-205912' do
  title "Windows Server 2019 Smart Card removal option must be configured to
...
specified, this is a finding:
    ...
    If configuring this on servers causes issues, such as terminating users'
remote sessions, and the organization has a policy in place that any other
sessions on the servers, such as administrative console logons, are manually
locked or logged off when unattended or not in use, this would be acceptable.

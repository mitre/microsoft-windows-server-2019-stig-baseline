...
control "V-93447" do
  title "Windows Server 2019 Kerberos user ticket lifetime must be limited to
10 hours or less."
...
Security Settings >> Account Policies >> Kerberos Policy.
    ...
    If the value for \"Maximum lifetime for user ticket\" is \"0\" or greater
than \"10\" hours, this is a finding.
  "

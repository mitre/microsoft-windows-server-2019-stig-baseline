control 'V-93457' do
  ...
  if domain_role == '4' || domain_role == '5'
    ...
    describe 'Inactive local accounts' do
      it "Servers should not have any Accounts that are Inactive over #{age} days" do
        failure_message = "User or Users have not logged in to system in #{age} days: #{untracked_accounts}"
        expect(untracked_accounts).to be_empty, failure_message
      end
    end
  end

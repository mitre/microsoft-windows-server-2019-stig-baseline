...
control "V-93489" do
  title "Windows Server 2019 must have the DoD Interoperability Root
Certificate Authority (CA) cross-certificates installed in the Untrusted
Certificates Store on unclassified systems."
...
this is not a finding.
    ...
    Issuer: CN=DoD Interoperability Root CA 1, OU=PKI, OU=DoD, O=U.S.
Government, C=US
    Thumbprint: 22BBE981F0694D246CC1472ED2B021DC8540A22F
    NotAfter: 9/6/2019

    Subject: CN=DoD Root CA 3, OU=PKI, OU=DoD, O=U.S. Government, C=US
    Issuer: CN=DoD Interoperability Root CA 2, OU=PKI, OU=DoD, O=U.S.
Government, C=US
...
Interoperability Root CA...\" under \"Issued By\":
    ...
    If the certificates below are not listed or the value for the
...
this is not a finding.
  ...
  "
  desc  "fix", "
    Install the DoD Interoperability Root CA cross-certificates on unclassified
systems.
...
IASE at http://iase.disa.mil/pki-pke/Pages/tools.aspx.
  "
  impact 0.5
  tag severity: nil

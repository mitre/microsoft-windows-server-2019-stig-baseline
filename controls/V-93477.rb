...
control "V-93477" do
  title "Windows Server 2019 maximum password age must be configured to 60 days
or less."
...
Settings >> Security Settings >> Account Policies >> Password Policy.
    ...
    If the value for the \"Maximum password age\" is greater than \"60\" days,
this is a finding.
    ...
    If \"MaximumPasswordAge\" is greater than \"60\" or equal to \"0\" in the

...
control 'SV-205715' do
  title "Windows Server 2019 local administrator accounts must have their
privileged token filtered to prevent elevated privileges from being used over
the network on domain-joined member servers."
...
\\Windows\\PolicyDefinitions\\en-US directories respectively.
  ...
  if domain_role == '3'
    ...
    describe 'This requirement is only applicable to member servers' do
      skip 'This control is N/A as the requirement is only applicable to member servers.'
    end
  end

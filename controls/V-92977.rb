...
control "V-92977" do
  title "Windows Server 2019 must automatically remove or disable emergency
...
access control policy requirements."
  desc  "rationale", ""
  desc  'check', "Determine if emergency administrator accounts are used and identify any
...
AccountExpirationDate\".
    ...
    If \"AccountExpirationDate\" has been defined and is not within 72 hours
for an emergency administrator account, this is a finding.
...
emergency administrator account, this is a finding."
  desc  'fix', "Remove emergency administrator accounts after a crisis has been resolved or

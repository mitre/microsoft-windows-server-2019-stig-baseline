control 'SV-205662' do
  ...
  desc 'fix', %q(Configure the policy value for Computer Configuration >> Windows Settings >> Security Settings >> Account Policies >> Password Policy >> "Minimum password length" to "#{input('minimum_password_length')}" characters.)
  impact 0.5
  tag severity: nil

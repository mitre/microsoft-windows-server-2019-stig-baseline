...
tools."
  desc  "rationale", ""
  desc  "check", "
    Verify DoD approved HBSS software is installed, configured, and properly
operating. Ask the operator to document the HBSS software installation and
configuration.
...
or used, this is a finding.
  "
  desc  "fix", "Install a DoD approved HBSS software and ensure it is operating
continuously."
  impact 0.5
  tag severity: nil

...
control "V-93515" do
  title "Windows Server 2019 systems requiring data at rest protections must
...
data structures (e.g., files, records, or fields).
  ...
  desc  "rationale", ""
  desc  "check", "
    Verify systems that require additional protections due to factors such as
inadequate physical protection or sensitivity of the data employ encryption to

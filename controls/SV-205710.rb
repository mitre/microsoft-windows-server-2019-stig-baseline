control 'SV-205710' do
  ...
  desc 'check', %q(Determine if emergency administrator accounts are used and identify any that exist. If none exist, this is NA.
  ...
  desc 'fix', %q(Remove emergency administrator accounts after a crisis has been resolved or configure the accounts to automatically expire within #{input('emergency_account_period') * 24} hours.

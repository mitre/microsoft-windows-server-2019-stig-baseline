control 'SV-205800' do
  ...
  desc 'check', %q(Review the Windows time service configuration.
  ...
  desc 'fix', %q(Configure the system to synchronize time with an appropriate #{input('org_name')[:acronym]} time
  source.

...
exposing them to theft. WDigest is disabled by default in Windows Server 2019.
...
Templates >> MS Security Guide >> \"WDigest Authentication (disabling may
require KB2871997)\" to \"Disabled\".

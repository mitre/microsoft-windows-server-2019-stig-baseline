...
control 'SV-205706' do
  title "Windows Server 2019 computer clock synchronization tolerance must be
...
Security Settings >> Account Policies >> Kerberos Policy.
    ...
    If the \"Maximum tolerance for computer clock synchronization\" is greater
than \"5\" minutes, this is a finding.
  "

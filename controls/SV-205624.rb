control 'SV-205624' do
  ...
  desc 'check', %q(Review temporary user accounts for expiration dates.
  ...
  desc 'fix', %q(Configure temporary user accounts to automatically expire within #{input('temporary_account_period') * 24} hours.

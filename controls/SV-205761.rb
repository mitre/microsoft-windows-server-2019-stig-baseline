...
control 'SV-205761' do
  title "Windows Server 2019 Increase scheduling priority: user right must only
...
\"Increase scheduling priority\" user right, this is a finding:
...
\"SeIncreaseBasePriorityPrivilege\" user right, this is a finding:
...
scheduling priority\" to include only the following accounts or groups:

...
control 'SV-205682' do
  title "Windows Server 2019 must not the Server Message Block (SMB) v1
protocol installed."
...
preimage attacks and is not FIPS compliant."
  desc  'rationale', ''
  desc  'check', "
    Different methods are available to disable SMBv1 on Windows Server 2019.
This is the preferred method, however if WN19-00-000390 and WN19-00-000400 are

...
control 'SV-205717' do
  title "Windows Server 2019 User Account Control must, at a minimum, prompt
...
to complete a task that requires raised privileges."
  desc  'rationale', ''
  desc  'check', "
    UAC requirements are NA for Server Core installations (this is default
...
Mode\" to \"Prompt for consent on the secure desktop\".

    The more secure option for this setting, \"Prompt for credentials on the
secure desktop\", would also be acceptable.
  "
  impact 0.5
  tag severity: 'medium'

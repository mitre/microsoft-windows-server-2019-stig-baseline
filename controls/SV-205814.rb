...
control 'SV-205814' do
  title "Windows Server 2019 must restrict unauthenticated Remote Procedure
Call (RPC) clients from connecting to the RPC server on domain-joined member
...
connecting to the RPC server will prevent anonymous connections."
  desc  'rationale', ''
  desc  'check', "
    This applies to member servers and standalone systems, it is NA for domain
controllers.

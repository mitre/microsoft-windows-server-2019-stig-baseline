...
for java.exe, javaw.exe, and javaws.exe."
...
of all application mitigations configured.)
    ...
    If the following mitigations do not have a status of \"ON\" for each, this
is a finding:
...
required status of \"ON\" are listed here.
  "
  desc  "fix", "
    Ensure the following mitigations are turned \"ON\" for java.exe, javaw.exe,
and javaws.exe:

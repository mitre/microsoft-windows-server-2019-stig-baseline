...
control 'SV-205716' do
  title "Windows Server 2019 UIAccess applications must not be allowed to
...
without using the secure desktop\" to \"Disabled\"."
  ...
  if os_type == 'False'
    impact 0.0
    describe 'This system is a Server Core Installation, control is N/A.' do
      skip 'This system is a Server Core Installation control is N/A.'
    end
  else

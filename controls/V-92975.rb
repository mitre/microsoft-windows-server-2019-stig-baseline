# encoding: UTF-8
 ...
 control 'V-92975' do
    ...
    If temporary accounts are used, the operating system must be configured to automatically terminate these types of accounts after a #{input('org_name')}-defined time period of 72 hours.

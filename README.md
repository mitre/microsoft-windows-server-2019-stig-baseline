...
InSpec profile to validate the secure configuration of Microsoft Windows Server 2019, against [DISA](https://iase.disa.mil/stigs/)'s Microsoft Windows Server 2019 Security Technical Implementation Guide (STIG) Version 2, Release 2.
